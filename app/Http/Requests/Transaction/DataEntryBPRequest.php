...
class DataEntryBPRequest extends FormRequest
{
    /**
    ...
    public function createRules(): array
    {
        return [
            ...
            'biller_fields' => 'required|array',
            'biller_fields.*.value' => 'required_if:biller_fields.*.require,true',
            'purpose' => 'required',
    ...
    public function messages()
    {
        ...
        foreach ($this->get('biller_fields') as $key => $field) {
            $messages["biller_fields.$key.value.required_if"] = $field['label'] . " is required.";
        }
