        ...
        <div class="table-holder mb-4">
            <div class="row">
                <div class="col-md-12 h-section">
                    ...
                    <p class="description">A comprehensive list of CREDIT TO ACCOUNT(BANKS) from EOS.</p>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-end">
                <LaravelVuePagination class="m-0" :data="banks" @pagination-change-page="paginatedBranches" ></LaravelVuePagination>
            </div>
